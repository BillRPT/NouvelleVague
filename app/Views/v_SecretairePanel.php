...
<body>
    ...
    <div class="link-container" style="text-align: center;">
        <?php echo anchor('creerEvenements', 'Créer un nouvel événement');?><?php echo anchor('supprimerEvenement', 'Supprimer un événement');?><?php echo anchor('modifierEvenement', 'Modifier un événement');?>