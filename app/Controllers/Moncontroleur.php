...
class Moncontroleur extends BaseController
{
    ...
    public function index() {
        ...
        //recup le nombre de evenement
        $nbEvent = $monModele->nbEvenements();

        //Vérifier si il est co ou pas 
        if ($this->session->get('user')) {
            if ($session->get('role') == "maire" || $session->get('role') == "secretaire") {
                if ($nbEvent > 0) {
                    return view('v_Header.php').view('v_BouttonDeconnexion.php').view('v_BouttonAdministration.php').view('v_Accueil.php').view("v_AccueilEvenements.php", $data).view("v_AccueilFooter.php");
                }
                else {
                    return view('v_Header.php').view('v_BouttonDeconnexion.php').view('v_BouttonAdministration.php').view('v_Accueil.php').view("v_AccueilAucunEvenements.php").view("v_AccueilFooter.php");
                }
            }
            else {
                if ($nbEvent > 0) {
                    return view('v_Header.php').view('v_BouttonDeconnexion.php').view('v_Accueil.php').view("v_AccueilEvenements.php", $data).view("v_AccueilFooter.php");
                }
                else {
                    return view('v_Header.php').view('v_BouttonDeconnexion.php').view('v_Accueil.php').view("v_AccueilAucunEvenements.php").view("v_AccueilFooter.php");
                }
            }
        } else {
            // Utilisateur non connecté
            if ($nbEvent > 0) {
                return view('v_Header.php').view('v_BouttonConnexion.php').view('v_Accueil.php').view("v_AccueilEvenements.php", $data).view("v_AccueilFooter.php");
            }
            else {
                return view('v_Header.php').view('v_BouttonConnexion.php').view('v_Accueil.php').view("v_AccueilAucunEvenements.php").view("v_AccueilFooter.php");
            }
        }
    }
